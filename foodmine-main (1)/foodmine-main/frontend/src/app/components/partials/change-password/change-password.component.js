...
let ChangePasswordComponent = (() => {
    ...
    let _classThis;
    var ChangePasswordComponent = _classThis = class {
        ...
        constructor(userService, activatedRoute, router) {
            ...
            this.changePasswordForm = new forms_1.FormGroup({
                ...
                newPassword: new forms_1.FormControl('', [forms_1.Validators.required, forms_1.Validators.minLength(5)]),
                confirmPassword: new forms_1.FormControl('', [forms_1.Validators.required])
            }, {
                validators: [(0, password_match_validator_1.PasswordsMatchValidator)('newPassword', 'confirmPassword')]
            });
    ...
    __setFunctionName(_classThis, "ChangePasswordComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ChangePasswordComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ChangePasswordComponent = _classThis;
})();
