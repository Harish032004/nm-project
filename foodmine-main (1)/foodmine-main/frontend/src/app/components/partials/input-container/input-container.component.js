...
exports.InputContainerComponent = void 0;
...
let InputContainerComponent = (() => {
    ...
    var InputContainerComponent = _classThis = class {
        constructor() {
            this.label = __runInitializers(this, _label_initializers, void 0);
            this.bgColor = (__runInitializers(this, _label_extraInitializers), __runInitializers(this, _bgColor_initializers, 'white'));
            __runInitializers(this, _bgColor_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "InputContainerComponent");
    (() => {
        ...
        InputContainerComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return InputContainerComponent = _classThis;
})();
